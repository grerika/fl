...
# 4. A terhességi korral arányosan növekszig a medencefenék izmainak megnyúlása.
...
xl = c(0,9)
co=c("black")
jpeg('Hip5_dX_plot.jpg',width = 1000, height = 500)
...
plot(c(time,time,time),c(yConfLower,yATLAG,yConfUpper),col=co,xlab="x. kontroll",ylab="dX érték (95% CI)",xlim=xl,ylim=yl)

lines(time,yATLAG,ylim=yl,type="l",lt=1)
lines(time,yConfLower,ylim=yl,type="l",lt=2)
lines(time,yConfUpper,ylim=yl,type="l",lt=3)
legend("topright", legend=c("átlag", "alsó határ","felső határ"),
       col=grey.colors(3), lty=1:3, cex=0.8)
dev.off()
...
#co=c("red","red","red","red","red","red","red","red","green","green","green","green","green","green","green","green","blue","blue","blue","blue","blue","blue","blue","blue")
co=c("black")
jpeg('Hip5_dD_plot.jpg',width = 1000, height = 500)
plot(c(time,time,time),c(yConfLower,yATLAG,yConfUpper),col=co,xlab="x. kontroll",ylab="dD érték (95% CI)",xlim=xl,ylim=yl)
lines(time,yATLAG,ylim=yl,type="l",lt=1)
lines(time,yConfLower,ylim=yl,type="l",lt=2)
lines(time,yConfUpper,ylim=yl,type="l",lt=3)
legend(-0.4, 3.5, legend=c("átlag", "alsó hatar","felső határ"),
       col=grey.colors(3), lty=1:3, cex=0.8)
dev.off()
#par(new = TRUE);plot(time,yConfLower,col="blue",xlim=xl,ylim=yl, xlab='', ylab='', axes=F);par(new = FALSE)
...
```{r}
df = data.frame(c(Tkor_1,Tkor_2,Tkor_3,Tkor_4,Tkor_5,Tkor_6,Tkor_7,Tkor_8,Sz_het),c(dL_1,dL_2,dL_3,dL_4,dL_5,dL_6,dL_7,dL_8,dL_9))
xTkor = df$c.Tkor_1..Tkor_2..Tkor_3..Tkor_4..Tkor_5..Tkor_6..Tkor_7..Tkor_8..Sz_het.
ydL = df$c.dL_1..dL_2..dL_3..dL_4..dL_5..dL_6..dL_7..dL_8..dL_9.
summary(ydL)
time = 1:9
yATLAG = c(mean(dL_1,na.rm=T),mean(dL_2,na.rm=T),mean(dL_3,na.rm=T),mean(dL_4,na.rm=T),mean(dL_5,na.rm=T),mean(dL_6,na.rm=T),mean(dL_7,na.rm=T),mean(dL_8,na.rm=T),mean(dL_9,na.rm=T))
...
dL = t.test(dL_9); dL9_conf=c(dL$conf.int[1],dL$conf.int[2])
yConfLower = c(dL1_conf[1],dL2_conf[1],dL3_conf[1],dL4_conf[1],dL5_conf[1],dL6_conf[1],dL7_conf[1],dL8_conf[1],dL9_conf[1])
yConfUpper = c(dL1_conf[2],dL2_conf[2],dL3_conf[2],dL4_conf[2],dL5_conf[2],dL6_conf[2],dL7_conf[2],dL8_conf[2],dL9_conf[2])
yl=c(min(yConfLower),max(yConfUpper))
xl = c(0,9)
co=c("black")
jpeg('Hip5_dL_plot.jpg',width = 500, height = 300)
#plot(xTkor,ydL,xlab="Tkor",ylab="dL")
#co=c("black","red","red","red","red","red","red","red","green","green","green","green","green","green","green","green","blue","blue","blue","blue","blue","blue","blue","blue")
plot(c(time,time,time),c(yConfLower,yATLAG,yConfUpper),col=co,xlab="x. kontroll",ylab="dL érték (95% KI)",xlim=xl,ylim=yl)

lines(time,yATLAG,ylim=yl,type="l",lt=1)
lines(time,yConfLower,ylim=yl,type="l",lt=2)
lines(time,yConfUpper,ylim=yl,type="l",lt=3)
legend("bottomright", legend=c("átlag", "alsó hatar","felső határ"),
       col=grey.colors(3), lty=1:3, cex=0.8)
dev.off()
...
co=c("black")
jpeg('Hip5_dH_plot.jpg',width = 1000, height = 500)
plot(c(time,time,time),c(yConfLower,yATLAG,yConfUpper),col=co,xlab="x. kontroll",ylab=" dH érték (95% CI)",xlim=xl,ylim=yl)
...
```{r}
df = data.frame(c(Tkor_1,Tkor_2,Tkor_3,Tkor_4,Tkor_5,Tkor_6,Tkor_7,Tkor_8,Sz_het),c(dB_1,dB_2,dB_3,dB_4,dB_5,dB_6,dB_7,dB_8,dB_9))
xTkor = df$c.Tkor_1..Tkor_2..Tkor_3..Tkor_4..Tkor_5..Tkor_6..Tkor_7..Tkor_8..Sz_het.
ydB = df$c.dB_1..dB_2..dB_3..dB_4..dB_5..dB_6..dB_7..dB_8..dB_9.
summary(ydB)
time = 1:9
yATLAG = c(mean(dB_1,na.rm=T),mean(dB_2,na.rm=T),mean(dB_3,na.rm=T),mean(dB_4,na.rm=T),mean(dB_5,na.rm=T),mean(dB_6,na.rm=T),mean(dB_7,na.rm=T),mean(dB_8,na.rm=T),mean(dB_9,na.rm=T))
...
dB = t.test(dB_9); dB9_conf=c(dB$conf.int[1],dB$conf.int[2])
yConfLower = c(dB1_conf[1],dB2_conf[1],dB3_conf[1],dB4_conf[1],dB5_conf[1],dB6_conf[1],dB7_conf[1],dB8_conf[1],dB9_conf[1])
yConfUpper = c(dB1_conf[2],dB2_conf[2],dB3_conf[2],dB4_conf[2],dB5_conf[2],dB6_conf[2],dB7_conf[2],dB8_conf[2],dB9_conf[2])
yl=c(min(yConfLower),max(yConfUpper))
xl = c(0,9)
#plot(xTkor,ydB,xlab="Tkor",ylab="dB")
#co=c("red","red","red","red","red","red","red","red","green","green","green","green","green","green","green","green","blue","blue","blue","blue","blue","blue","blue","blue")

jpeg('Hip5_dB_plot.jpg',width = 500, height = 300)
plot(c(time,time,time),c(yConfLower,yATLAG,yConfUpper),col=co,xlab="x. kontroll",ylab="dB érték (95% KI)",xlim=xl,ylim=yl)
...
#co=c("red","red","red","red","red","red","red","red","green","green","green","green","green","green","green","green","blue","blue","blue","blue","blue","blue","blue","blue")
jpeg('Hip5_dC_plot.jpg',width = 1000, height = 500)
plot(c(time,time,time),c(yConfLower,yATLAG,yConfUpper),col=co,xlab="x. kontroll",ylab="dC (95% KI)",xlim=xl,ylim=yl)

lines(time,yATLAG,ylim=yl,type="l",lt=1)
lines(time,yConfLower,ylim=yl,type="l",lt=2)
lines(time,yConfUpper,ylim=yl,type="l",lt=3)
legend("topright", legend=c("átlag", "alsó hatar","felső határ"),
       col=grey.colors(3), lty=1:3, cex=0.8)
dev.off()
